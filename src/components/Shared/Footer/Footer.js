...
const image = ('https://i.ibb.co/vcCNpSh/banner12.jpg');
const bannerBackground = {
    background: `url(${image})`,
    backgroundColor: 'rgba(1, 28, 38, 0.99 )',
...
const Footer = () => {
    ...
    return (
        <Box style={bannerBackground} sx={{background: '#F7F7F7'}}>
            <Container>
                <Box sx={{flexGrow: 1}}>
                    <Grid container spacing={{ xs: 3, md: 5 }} sx={{mb: 5}}>
                        <Grid item xs={12} sm={12} md={3}>
                            <List sx={{mt:5}}>
                                <Typography variant='h4' sx={{mb:1, color: 'white'}}>Daily Yoga</Typography>
                                <Typography variant='body1' sx={{mb:3, color: 'white'}}>The Daily Yoga is an exclusive and committed organization to spread the information of the Yoga.</Typography>
                        ...
                        <Grid item xs={12} sm={12} md={3}>
                            <List sx={{mt:5}}>
                                <Typography sx={{fontSize: '24px', color: '#ffff', mb: 1}}>Our Process
                                </Typography>
                        ...
                        <Grid item xs={12} sm={12} md={3}>
                            <List sx={{mt:5}}>
                                <Typography sx={{fontSize: '24px', color: '#ffff', mb: 1}}>Resources
                                </Typography>
                        ...
                        <Grid item xs={12} sm={12} md={3}>
                            <List sx={{mt:5}}>
                                <Typography sx={{fontSize: '24px', color: '#ffff', mb: 1}}>Connect with Us</Typography>
                                ...
                                <ListItemText sx={{fontSize: '20px', color: '#ffff'}}>333/5 DestintGer, OldHome</ListItemText>
                                <ListItemText sx={{fontSize: '20px', color: '#ffff'}}>YanstShayer</ListItemText>
                                <ListItemText sx={{fontSize: '20px', color: '#ffff', mb: 1}}>Tel: +022 555 696969</ListItemText>
                            </List>
                        </Grid>
                    </Grid>
                </Box>
            ...
            <Container sx={{py: 3}}>
            <Typography sx={{color: '#2b6d7d',}}>Copyright - &copy;{new Date().getFullYear()} || All rights reserved By - <strong>Daily Yoga</strong> || Designed by- ApuDebnath</Typography>
            </Container>
